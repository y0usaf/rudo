...
const PINNED_ENV_VAR: &str = "TERMVIDE_SYSTEM_PINNED_HOTKEY";
const SWITCHER_ENV_VAR: &str = "TERMVIDE_SYSTEM_SWITCHER_HOTKEY";
const LEGACY_ENV_VAR: &str = "TERMVIDE_MACOS_ACTIVATION_HOTKEY";
